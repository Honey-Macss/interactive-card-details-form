const Inputs = ({label, placeHolders, width}) => {
  return (
    <div className=" grid ">
        ...
        <input className= {` ${width} mt-[0.4rem] text-[#2c2631] text-[1.1rem] mi:text-[0.9rem] border-[1px] hover:border-[#684e79] cursor-pointer outline-none rounded-[10px] p-[0.7rem_0_0.7rem_1rem] font-medium tracking-wide`} type="text" placeholder={placeHolders} />
